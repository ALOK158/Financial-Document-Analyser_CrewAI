...
* **LLM Engine:** [Groq](https://groq.com/) (Model: `llama-3.1-8b-instant`)
    * *Why:* Chosen for its near-instant inference speed (300+ tokens/s), which is critical for real-time financial analysis agents and it is only cloud LLM with most number of API calls up for free.
